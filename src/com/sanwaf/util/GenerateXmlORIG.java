...
/*
 * need main method that takes:
 * 1. root path to start search
 * 2. optional, comma delim list of sub-paths (if not specified, uses 1 only)
 * 3. optional, comma delim list of extension (if not specified, uses html)
 * 4. output file
 * 
 * for the output file, search for a begin & end marker to replace the value with what is generated 
 * 
 ...
 * subpath=jsp,html
 * 
 * ./foo/bar/webapp/jsp1/*.jsp
 * ./foo/bar/webapp/html/*.html
 * 
 * 
 * path = eclipseProjects
 * subpath=pccweb/jsp,pccadmin/jsp
 * 
 * eclipseProjects/pccweb/jsp
 * eclipseProjects/pccadmin/jsp
 * 
 * 
 * Example:
 * 
 * java -jar genSanwafXml --path:<path> --subpathlist:<path1,path2...> --extentions:<html,jsp,...> --output:<sanwaf.xml>
 * 
 * 
 * 
 * 
 * NOTES:
 * all URI generated needs paths to be "/" not "\"
 * 
 * 
 */
